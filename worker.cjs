...
runAsWorker(
  ...
  async (
    source,
    { filepath, onDiskFilepath, parserMeta, parserPath, usePrettierrc, ...eslintPrettierOptions },
    ...
    if (filepath === onDiskFilepath) {
      ...
      switch (inferredParser) {
        ...
        case 'html': {
          ...
          if (
            (typeof parserMeta !== 'undefined' && parserMeta.name !== '@html-eslint/parser') ||
            (typeof parserPath === 'string' && !/([\\/])@html-eslint\1parser\1/.test(parserPath))
          ) {
            inferParserToBabel = true;
          }
          break;
        ...
        case 'markdown': {
          ...
          if (
            (typeof parserMeta !== 'undefined' && parserMeta.name !== 'eslint-mdx') ||
            (typeof parserPath === 'string' && !/([\\/])eslint-mdx\1/.test(parserPath))
          ) {
            inferParserToBabel = true;
          }
          break;
        ...
        case 'svelte': {
          ...
          if (typeof parserPath === 'string' && !/([\\/])svelte-eslint-parser\1/.test(parserPath)) {
