import { GeneratorOptions } from "./babel-generator.d.ts";
import { ParserOptions } from "./babel-parser.d.ts";
import template from "./babel-template.d.ts";
import traverse, { Hub, NodePath, Scope, Visitor } from "./babel-traverse.d.ts";
import * as t from "./babel-types.d.ts";

export { GeneratorOptions, NodePath, ParserOptions, t as types, template, traverse, Visitor };

export type Node = t.Node;
export type ParseResult = ReturnType<typeof import("./babel-parser.d.ts").parse>;
